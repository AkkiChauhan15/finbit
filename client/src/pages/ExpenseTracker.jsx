...
function ExpenseTracker() {
  ...
  return (
    <div className="space-y-8">
      <header>
        <p className="text-sm font-medium text-emerald-400">Cash flow workspace</p>
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-900 p-5 sm:p-6">
        <form onSubmit={applyFilters}>
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            ...
            {filterError && <p className="text-sm text-rose-400">{filterError}</p>}
          </div>
          <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <label className="text-sm font-medium text-slate-200">
              ...
              <input
                ...
                className="mt-2 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2.5 text-white outline-none focus:border-emerald-500"
              />
            </label>
            <label className="text-sm font-medium text-slate-200">
              End date
            ...
            <div className="flex gap-2 sm:col-span-2 lg:col-span-1 lg:self-end">
              <button
                type="submit"
                className="flex-1 rounded-lg bg-slate-100 px-4 py-2.5 font-semibold text-slate-950 hover:bg-white"
              >
                Apply
              </button>
              <button
      ...
      {isLoading ? (
        ...
        <div className="rounded-2xl border border-rose-500/30 bg-rose-500/10 px-6 py-10 text-center">
          <p className="font-medium text-rose-200">We couldn’t load your cash-flow data.</p>
        ...
        <>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-5">
              <p className="text-sm text-emerald-200/70">Income in selected period</p>
              <p className="mt-2 text-2xl font-bold text-emerald-300">
                {formatCurrency(totalIncome, currency)}
              </p>
            </div>
            <div className="rounded-2xl border border-rose-500/20 bg-rose-500/10 p-5">
              <p className="text-sm text-rose-200/70">Expenses in selected period</p>
